...
TCCR0A=(0<<WGM00) | (0<<COM0A1) | (0<<COM0A0) | (0<<WGM01) | (0<<CS02) | (0<<CS01) | (0<<CS00);
TCNT0=0x00;
OCR0A=0x00;
...
ASSR=(0<<EXCLK) | (0<<AS2);
TCCR2A=(0<<WGM20) | (0<<COM2A1) | (0<<COM2A0) | (0<<WGM21) | (0<<CS22) | (0<<CS21) | (0<<CS20);
TCNT2=0x00;
OCR2A=0x00;
...
// CAN disabled
CANGCON=(0<<ABRQ) | (0<<OVRQ) | (0<<TTC) | (0<<SYNTTC) | (0<<LISTEN) | (0<<TEST) | (0<<ENASTB) | (0<<SWRES);
